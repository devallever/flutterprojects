...
class BasicFunList2 extends BaseFunListPage {
  ...
  List<ItemFunData> getData() {
    ...
    list.add(
        ItemFunData(title: "基础控件", desc: "基础控件基本用法", itemClick: (data) => {}));
    list.add(ItemFunData(
        title: "高级控件-列表", desc: "高级控件基本用法，列表", itemClick: (data) => {}));
    list.add(ItemFunData(
        title: "高级控件-网格", desc: "高级控件基本用法，网格", itemClick: (data) => {}));
    list.add(ItemFunData(
        title: "高级控件-ViewPager", desc: "高级控件基本用法，分页", itemClick: (data) => {}));
    return list;
  }
}
